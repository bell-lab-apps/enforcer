/*!
 * enforcer v1.0.0: A lightweight form validation library that augments native HTML5 form validation elements and attributes.
...
(function (root, factory) {
    ...
    var defaults = {
        ...
        fieldPrefix: 'enforcer-field_',
        errorPrefix: 'enforcer-error_',
    ...
    var missingValue = function (field) {
        ...
        if (!field.hasAttributes('required')) return false;
    ...
    var showError = function (field, errors, settings) {
        ...
        if (settings.emitEvents) {
            emitEvent(field, 'enforcerShowError', {
                errors: errors
            });
        }
    };
    ...
    var removeError = function (field, settings) {
        ...
        // Emit custom event
        if (settings.emitEvents) {
            emitEvent(field, 'enforcerRemoveError');
        }
    };
    ...
    var Constructor = function (selector, options) {
        ...
        var submitHandler = function (event) {
            ...
            // Emit custom event
            if (settings.emitEvents) {
                emitEvent(event.target, 'enforcerFormValid');
            }
        };
        ...
        publicAPIs.destroy = function () {
            ...
            // Emit custom event
            if (settings.emitEvents) {
                emitEvent(document, 'enforcerDestroyed', {
                    settings: settings
                });
            }
        ...
        var init = function () {
            ...
            // Emit custom event
            if (settings.emitEvents) {
                emitEvent(document, 'enforcerInitialized', {
                    settings: settings
                });
            }
        };
