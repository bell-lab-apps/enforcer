<form data-validate>
	...
	<div>
		...
		<input type="email" name="email" id="email" value="" data-enforcer-message="The domain portion of the email address is invalid (the portion after the @)." required>
	</div>

	<div>
		<label for="url">URL</label>
		<input type="url" name="url" id="url" value="" data-enforcer-message="The URL is a missing a TLD (for example, .com)." required>
	</div>
